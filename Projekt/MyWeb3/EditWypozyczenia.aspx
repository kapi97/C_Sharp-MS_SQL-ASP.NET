<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditWypozyczenia.aspx.cs" Inherits="MyWeb3.EditWypozyczenia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
    <asp:Label ID="m_id_wypozyczenie" runat="server" Text="Label"></asp:Label><br />
    <asp:TextBox ID="m_wypozyczony_film" runat="server"></asp:TextBox><br />
    <asp:TextBox ID="m_okres_wypozyczenia" runat="server"></asp:TextBox><br />
    <asp:TextBox ID="m_id_klient" runat="server"></asp:TextBox><br />
