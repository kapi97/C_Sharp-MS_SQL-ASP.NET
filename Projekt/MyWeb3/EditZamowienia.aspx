<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditZamowienia.aspx.cs" Inherits="MyWeb3.EditZamowienia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
    <asp:Label ID="m_id_zamowienie" runat="server" Text="Label"></asp:Label><br />
    <asp:TextBox ID="m_zamowiony_film" runat="server"></asp:TextBox><br />
