...
namespace MyWeb3
{
    public partial class Filmy : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sb1.Append("select id_film,tytul,gatunek,rok,cena_kupna,cena_wypozyczenia from dbo.filmy");
            if (strSearch.Length > 0)
            {
                //sb1.AppendFormat(" where LastName like '%{0}%'", strSearch);
                sb1.Append(" where tytul like @LIKENAME");
            }
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                this.m_rptFilmy.DataSource = ds;

                this.m_rptFilmy.DataBind();
            }
